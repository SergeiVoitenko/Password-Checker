// Розширений список поширених паролів
const commonPasswords = [
    // Англійські поширені паролі
    ...
    // Українські/російські поширені імена та шаблони
    ...
    "привіт", "пароль", "секрет", "любов", "друг", "кішка", "собака", "авто",
    "робота", "дім", "родина", "дитина", "сонце", "зірка", "місяць", "небо",
    // Поширені імена з числами
    "сергій123", "андрій123", "максим123", "іван123", "сашко123", "дмитро123",
    // Роки
